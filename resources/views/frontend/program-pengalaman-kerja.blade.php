...
@section('content')
    ...
    <h1 class="page-header__heading slide-title__heading">Program Pengalaman Kerja</h1>
    ...
    <li class="noile-breadcrumb__item">Program Pengalaman Kerja</li>
    </ul>
    </div>
    ...
    <!-- Program Pengalaman Kerja Start -->
    <section class="Program Pengalaman Kerja">
    ...
    @endif
    <p class="sec-title__top">Program Pengalaman Kerja</p>
    </div>
    <h2 class="solution-one__heading sec-title__heading">Program Pengalaman Kerja Badan Hukum
    </h2>
