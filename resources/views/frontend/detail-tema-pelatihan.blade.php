...
@section('content')
  ...
  <h2 class="solution-one__heading sec-title__heading">Bimtek Manajemen Pegawai Negeri Sipil PP 17 Tahun 2020 Perubahan PP 11 Tahun 2017.
  </h2>
  <p class="blog-details__card-desc-one">
  Penataan birokrasi merupakan salah satu kebijakan pemerintah yang bertujuan salah satunya adalah untuk penyederhanaan
  birokrasi. Kebijakan ini dapat berdampak terhadap perubahan pengaturan manajemen aparatur sipil negara pada instansi
  pemerintah maka Presiden dapat menerbitkan Peraturan Presiden. Adalah tugas pemerintah untuk tetap dapat menjamin karier
  ...
  tentang pendelegasian kewenangan Presiden, kedudukan JF, mutasi JPT, penugasan PNS, pengembangan kompetensi, BUP Pejabat
