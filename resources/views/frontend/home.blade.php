                ...
                <div class="row g-0 h-100">
                    <div class="col-12 p-0" style="
                        ...
                        <div class="col-lg-7 col-md-12 p-5 ms-4 my-5">
                            <div class="sec-title__top-wrap mb-4 justify-content-sm-center">
                            ...
                            <h1 class="display-4 fw-bold text-sm-center">
                                {{ $hero ? $hero->heading : 'Pusat Studi Pengembangan Kompetensi' }}
                            </h1>
                            <p class="mt-4 text-muted text-sm-center">
                            ...
                            <div class="mt-4 d-flex flex-wrap gap-4 justify-content-sm-center">
