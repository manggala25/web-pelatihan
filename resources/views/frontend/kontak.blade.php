...
@section('content')
    ...
    @if ($gmapsFrame)
    {!! str_replace('<iframe', '<iframe class="google-map__default"', nl2br(htmlspecialchars_decode(e($gmapsFrame->link)))) !!}
    @else
    ...
    @if ($email)
    <a href="{!! nl2br(htmlspecialchars_decode(e($email->link))) !!}" class="contact-one__info-title contact-one__info-link">{!! nl2br(htmlspecialchars_decode(e($email->deskripsi))) !!}</a>
    @else
    <p>Tidak ada data untuk "email".</p>
    @endif
    </div>
    <div class="contact-one__info-item">
    ...
    <div class="col-md-9">
    <div class="contact__form-input-box">
    <label for="select-pelatihan" class="contact__input-title">Nama Pelatihan</label>
    <select name="contact-form-mail" id="select-pelatihan" class="contact__form-input">
