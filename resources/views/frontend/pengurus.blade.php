...
@section('content')
    ...
    <h1 class="page-header__heading slide-title__heading">Pengurus</h1>
    ...
    <li class="noile-breadcrumb__item">Pengurus</li>
    </ul>
    </div>
                ...
                <div class="col-xl-8 col-lg-7">
                        ...
                        <div class="solution-one__content sec-title">
                            <div class="sec-title__top-wrap">
                                ...
                                <p class="sec-title__top">
                                    {{ $pengurus ? $pengurus->top_title : 'Pengurus' }}
                                </p>
                            </div>
                            <h2 class="solution-one__heading sec-title__heading">
                                {{ $pengurus ? $pengurus->heading : 'Heading..' }}
                            </h2>
                    ...
                    <div class="col-md-12 mb-3">
                        <p class="blog-details__card-desc-three">
                            {!! nl2br(htmlspecialchars_decode(e($pengurus->content ?? 'konten masih kosong...'))) !!}
                        </p>
                    </div>
                    {{-- Informasi Penting --}}
