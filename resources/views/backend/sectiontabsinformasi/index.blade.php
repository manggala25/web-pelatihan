...
@section('content')
    ...
    <h4 class="card-title text-white mb-0">Tabel Section Tabs Informasi</h4>
    ...
    <th data-breakpoints="xs">Judul</th>
    <th data-breakpoints="sm">Heading</th>
    <th class="text-center" data-breakpoints="xs">Aksi</th>
    </tr>
    </thead>
    <tbody>
    @forelse ($sectiontabsinformasi as $key => $data)
    <tr>
    <td>{{ $key + 1 }}</td>
    ...
    <a href="{{ route('admin.sectiontabsinformasi.edit', $data->id) }}" class="btn btn-warning btn-circle">
    <i class="ri-edit-2-fill"></i>
    </a>
    <form action="{{ route('admin.sectiontabsinformasi.destroy', $data->id) }}" method="POST" class="delete-form"
