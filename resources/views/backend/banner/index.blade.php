...
@section('content')
  ...
  <div class="row">
    ...
    <div class="card">
      ...
      <h4 class="card-title text-white mb-0">Tabel Data Banner</h4>
    ...
    @endif
      ...
      <div class="table-responsive">
        ...
        <tr>
        <td>{{ $key + 1 }}</td>
        <td><img src="{{ asset('storage/' . $data->gambar) }}" alt="Gambar Banner"
        style="max-width: 200px; max-height: 100px;"></td>

        <td class="d-flex gap-2 text-white">
        <a href="{{ route('admin.banner.edit', $data->id) }}" class="btn btn-warning btn-circle">
        <i class="ri-edit-2-fill"></i>
        </a>
        <form action="{{ route('admin.banner.destroy', $data->id) }}" method="POST" class="delete-form"
