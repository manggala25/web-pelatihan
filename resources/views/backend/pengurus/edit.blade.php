        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-warning">
                    <h4 class="card-title text-white">Form Edit Pengurus</h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.pengurus.update', $pengurus->id) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="top_title" class="form-control" required
                                value="{{ old('top_title', $pengurus->top_title) }}" />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="heading" class="form-control" required
                                value="{{ old('heading', $pengurus->heading) }}" />
                        </div>

                        {{-- tujuan lemabaga dengan Summernote --}}
                        <div class="mb-3">
                            <label for="content">Isi Konten</label>
                            <textarea class="summernote" name="content">{{ old('content', $pengurus->content) }}</textarea>
                        </div>
