...
@section('content')
  ...
  <div class="col-12">
    ...
    <h4 class="card-title text-white mb-0">Tabel Data Section Homepage</h4>
    ...
    <table id="demo-foo-row-toggler" class="table table-bordered toggle-arrow-tiny text-nowrap"
      ...
      <td class="d-flex gap-2 text-white">
        <a href="{{ route('admin.section.show', $d->id) }}" class="btn btn-info btn-circle">
        <i class="ri-eye-line"></i>
        </a>
        <a href="{{ route('admin.section.edit', $d->id) }}" class="btn btn-warning btn-circle">
        <i class="ri-edit-2-fill"></i>
        </a>
        <form action="{{ route('admin.section.destroy', $d->id) }}" method="POST" class="delete-form"
